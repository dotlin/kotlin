...
abstract class CompletionSession(protected val configuration: CompletionSessionConfiguration,
    ...
    private fun createLookupElementFactory(): LookupElementFactory {
        ...
        else if (callType == CallType.INFIX)
        ...
        return LookupElementFactory(resolutionFacade, receiverTypes, contextType, InsertHandlerProvider { expectedInfos }, contextVariablesProvider)
    }
